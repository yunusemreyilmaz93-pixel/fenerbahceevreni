          ...
          <div className="lg:col-span-7 space-y-8 text-left">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
                <button
                  id="hero-cta-primary"
                  className="ui-button ui-button-primary w-full sm:w-auto px-8 py-3.5 bg-[#FFD21F] hover:bg-white text-[#0B0F19] font-black hover:scale-[1.02] active:scale-[0.98] rounded-xl shadow-[0_4px_30px_rgba(255,210,31,0.25)] flex items-center justify-center gap-2 group transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fb-yellow focus-visible:ring-offset-2 focus-visible:ring-offset-fb-dark"
                ...
                <button
                  ...
                  className="ui-button ui-button-secondary w-full sm:w-auto px-8 py-3.5 bg-white/[0.03] hover:bg-white/[0.08] text-white font-black rounded-xl border border-white/[0.08] hover:border-[#FFD21F]/40 hover:scale-[1.01] transition-all cursor-pointer"
